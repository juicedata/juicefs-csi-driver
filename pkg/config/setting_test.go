...
func TestGenHashOfSetting(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    "c70d286a1be115d37a47468a651136ede3cef0a40a22709026a9dfda2591caf",
			wantErr: false,
		},
		{
			name: "test-list1",
			...
			want:    "ce5172f75fcdc9938c35f60f1066b832bb19c1f545fa6dcd0ac24b6484ad6ec",
			wantErr: false,
		},
		{
			name: "test-list2",
		...
		},
		{
			...
			want:    "e8e95769bde5d118247c0431b51acc9aaee0e0ca3ff2d56aafd066349c4e734",
			wantErr: false,
		},
	}
	for _, tt := range tests {

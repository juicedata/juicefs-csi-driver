...
JUICEFS_MOUNT_IMAGE?=juicedata/mount:$(JUICEFS_CE_LATEST_VERSION)-$(JUICEFS_EE_LATEST_VERSION)
JUICEFS_MOUNT_NIGHTLY_IMAGE?=juicedata/mount:nightly-$(JUICEFS_EE_LATEST_VERSION)

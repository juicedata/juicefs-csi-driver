...
:::note
Upon mount point recovery, application pods will not be able to access files previously opened, you'll have to properly handle this type of error in your application.
:::

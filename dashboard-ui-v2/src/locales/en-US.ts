...
export default {
  ...
  yes: 'Yes',
  no: 'No',
  eeImage: 'Image for Cloud Service',
  ceImage: 'Image for Community',
  labels: 'Labels',
  annotations: 'Annotations',
  envs: 'Environments',
  resourceRequests: 'Resource Requests',
  resourceLimits: 'Resource Limits',
  enableNodeSelector: 'Enable NodeSelector',
  edit: 'Edit',
  finish: 'Finish',
  cpu: 'CPU',
  memory: 'Memory',
  ...
  pvcLabelMatch: 'PVC Matched Labels',
  pvcLabelExpression: 'PVC Label Expression',
  pvcMatched: 'Matched PVC',
  patch: 'PATCH',
  selector: 'Selector',
  allPVC: 'All PVCs',
